...
#__________________Define Error Tests_________________#
    ...
    def test_list_books_beyond_valid_page(self):
        ...
        self.assertEqual(data['success'], False)
        self.assertEqual(
            data['message'], "The server can not find the requested resource")
    ...
    def test_not_allowed_method(self):
        ...
        self.assertEqual(data['success'], False)
        self.assertEqual(
            data['message'], "This method is not allowed for the requested URL")
    ...
    def test_delete_nonexisting_book(self):
        ...
        self.assertEqual(data['success'], False)
        self.assertEqual(
            data['message'], "The request was unable to be followed due to semantic errors")
